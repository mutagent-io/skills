...
├── CHANGELOG.md
├── references/              — flat folder of skill content per agentskills.io spec
│   └── *.md                 — concept (WHY/WHAT) + workflow (HOW) files, all
│                              at the same level; journey router in SKILL.md
│                              picks the right ones per user intent
├── skills/
