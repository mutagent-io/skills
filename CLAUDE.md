...
- **Root** (`./SKILL.md` + `./concepts/` + `./workflows/` + `./CHANGELOG.md`)
  is the **source of truth**. Crawler-based registries (SkillsMP,
  claudeskills.info, Lobehub, majiayu000, SkillRegistry) discover SKILL.md
  here.
...
1. **Restructure first.** Move the existing root skill files back to their
   ...
   concepts/      → skills/mutagent-cli/concepts/
   workflows/     → skills/mutagent-cli/workflows/
   ```
