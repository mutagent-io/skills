...
1. Restructure: move the existing root files (`SKILL.md`, `CHANGELOG.md`,
   `concepts/`, `workflows/`) back to `skills/mutagent-cli/` as their
   canonical home; delete the now-empty top-level copies.
...
Edit at root (`./SKILL.md`, `./concepts/`, `./workflows/`). Then run
